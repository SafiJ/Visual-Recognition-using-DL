...
myDataset = dataset_base.copy({
	'name': 'HW3',
	'train_info': '/home/0616043/HW3/pascal_train.json',
	'train_images': '/home/0616043/HW3/train_images/',
	'valid_info': '/home/0616043/HW3/pascal_train.json',
	'valid_images': '/home/0616043/HW3/train_images/',
	'class_names': PASCAL_CLASSES,
	'label_map': None
})
...
myDataset_test = dataset_base.copy({
	'name': 'HW3-test',
	'valid_info': '/home/0616043/HW3/test.json',
	'valid_images': '/home/0616043/HW3/test_images',
	'has_gt': False,
	'class_names': PASCAL_CLASSES,
	'label_map': None
})
...
yolact_resnet50_myDataset_config = yolact_resnet50_config.copy({
	'name': 'yolact_resnet50_myDataset',
	'dataset': myDataset,
	'num_classes': 21,
	'max_size': 550,
})

test_config = yolact_resnet50_config.copy({
	'name': 'myDataset_test',
...
yolact_plus_resnet50_myDataset_config = yolact_plus_resnet50_config.copy({
	'name': 'yolact_plus_resnet50_myDataset',
	'dataset': myDataset,
	'num_classes': 21,
	'max_size': 550,
})

yolact_plus_resnet101_myDataset_config = yolact_plus_base_config.copy({
	'name': 'yolact_plus_resnet101_myDataset',
	'dataset': myDataset,
	'num_classes': 21,
	'max_size': 550,
})

test_plus_config = yolact_plus_resnet50_config.copy({
	'name': 'myDataset_test_plus',
	'dataset': myDataset_test,
	'num_classes': 21,
	'max_size': 550,
})
